...
import { ShoppingBag, ShieldCheck, MessageCircle, ArrowRight } from 'lucide-react';
...
export const Hero: React.FC<HeroProps> = () => {
  ...
  return (
    <header className="relative pt-16 pb-8 sm:pt-24 sm:pb-14 hero-pattern border-b border-gray-200/80 overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-3.5 sm:px-6 text-center relative z-10">
        
        {/* Top Eyebrow Badge */}
        <div className="inline-flex items-center gap-1.5 bg-blue-50 border border-blue-200 text-blue-900 px-3 py-1 rounded-full text-xs font-bold mb-3 sm:mb-5 shadow-xs text-left">
          <span>⚡ Workflow Terpadu Auditor Internal ISO 9001 & ISO 19011 • Auditor Pemula Pun Bisa</span>
        </div>

        {/* 1. HEADLINE */}
        <h1 className="text-xl sm:text-3xl md:text-4xl font-black tracking-tight text-gray-900 mb-3 sm:mb-5 leading-snug px-1">
          Audit Internal Sudah Dekat, Tapi Checklist dan Dokumennya Belum Siap?
        </h1>

        {/* 2. SUBHEADLINE */}
        <div className="max-w-2xl mx-auto mb-4 sm:mb-6 space-y-2">
          <p className="text-sm sm:text-lg font-bold text-blue-950 leading-relaxed px-1">
          ...
          <div className="inline-flex items-center gap-1.5 bg-emerald-50 border border-emerald-300 text-emerald-950 font-bold px-3 py-1 rounded-xl text-xs sm:text-sm">
            <span>✅</span>
        ...
        <div className="mb-5 sm:mb-7 relative max-w-2xl mx-auto">
          <div className="relative rounded-2xl p-1 bg-gradient-to-b from-slate-200 via-slate-100 to-slate-200 border border-slate-300 shadow-xl overflow-hidden">
            <div className="relative rounded-xl overflow-hidden bg-slate-950 border border-slate-800">
              ...
              <div className="flex items-center justify-between px-3 py-1.5 bg-slate-900 border-b border-slate-800 text-left">
                ...
                <span className="text-[10px] sm:text-xs text-slate-400 font-mono tracking-tight truncate max-w-[170px] sm:max-w-none">
                  app.smartauditsystem.com
                </span>
                <span className="text-[9px] font-bold text-emerald-400 bg-emerald-950/80 border border-emerald-800 px-1.5 py-0.2 rounded-full">
                  DASHBOARD ASLI
                </span>
              </div>
        ...
        <div className="space-y-2.5 max-w-sm sm:max-w-md mx-auto">
          ...
          <div className="bg-amber-50 border border-amber-300 text-amber-950 px-3 py-1.5 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-xs">
            <span className="text-amber-600 font-extrabold animate-pulse">⏰</span>
            <span className="text-[11px] sm:text-xs font-bold leading-tight">Harga Rp197.000 Hanya 3 Hari (Akan Naik ke Rp249.000)</span>
          </div>

          <div className="flex items-center justify-center gap-2 text-xs">
            <span className="text-gray-500 line-through font-semibold">Harga normal: Rp249.000</span>
            <span className="bg-red-100 text-red-700 font-black px-2 py-0.5 rounded-full text-xs">
          ...
          <a
            ...
            className="w-full inline-flex items-center justify-center gap-2 px-4 py-3.5 bg-gradient-to-r from-red-600 to-rose-700 hover:from-red-700 hover:to-rose-800 active:scale-[0.98] text-white rounded-2xl font-black text-sm sm:text-base transition-all shadow-lg shadow-red-600/30 border border-red-500/40 cursor-pointer min-h-[48px]"
          >
          ...
          <p className="text-[11px] sm:text-xs text-gray-600 font-medium leading-normal">
          ...
          <div className="pt-0.5 flex items-center justify-center gap-3">
            <a
              ...
              className="text-xs text-blue-900 hover:text-blue-950 font-bold underline inline-flex items-center gap-1 py-1"
            >
