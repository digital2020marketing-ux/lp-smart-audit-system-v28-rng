    ...
    <section id="cuplikan-video" className="py-8 sm:py-12 bg-slate-900 text-white border-b border-slate-800 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto px-3.5 sm:px-6 relative z-10">
        ...
        <div className="text-center max-w-xl mx-auto mb-5 sm:mb-7">
          <div className="inline-flex items-center gap-1 bg-blue-500/10 border border-blue-400/30 text-blue-300 px-3 py-1 rounded-full text-[11px] sm:text-xs font-bold uppercase tracking-wider mb-2">
            <Video className="w-3.5 h-3.5 text-blue-400" />
            <span>VIDEO PRATINJAU LANGSUNG</span>
          </div>
          <h2 className="text-lg sm:text-2xl md:text-3xl font-black text-white leading-snug px-1">
        ...
        <div className="bg-slate-950 border border-slate-800 rounded-2xl sm:rounded-3xl p-3.5 sm:p-5 shadow-2xl">
          
          {/* Main Selected Video Player */}
          <div className="max-w-[300px] sm:max-w-xs mx-auto mb-4">
            <div className="relative rounded-2xl overflow-hidden bg-black border border-slate-800 shadow-xl aspect-9/16 max-h-[440px] mx-auto flex items-center justify-center">
              {isPlaying ? (
                <iframe
                ...
                >
                  ...
                  <div className="relative z-10 bg-slate-950/85 backdrop-blur-xs px-3 py-1.5 rounded-xl border border-slate-700 max-w-[95%]">
            ...
            <div className="mt-2.5 text-center px-1">
              <div className="inline-block text-[10px] sm:text-xs font-black text-blue-400 bg-blue-950/80 border border-blue-800 px-2 py-0.5 rounded-full mb-1">
            ...
            {VIDEOS.map((vid) => {
              ...
              return (
                <button
                  ...
                  className={`text-left p-2.5 sm:p-3 rounded-xl sm:rounded-2xl border transition-all flex items-center gap-2.5 cursor-pointer min-h-[48px] ${
                    isCurrent
