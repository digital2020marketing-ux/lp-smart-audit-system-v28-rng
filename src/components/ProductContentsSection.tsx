...
export const ProductContentsSection: React.FC = () => {
  return (
    <section id="isi-produk" className="py-10 sm:py-14 bg-white border-b border-gray-200">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
          ...
          <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-5 flex flex-col justify-between shadow-xs">
            <div>
              <div className="flex items-center gap-2.5 mb-3">
                ...
                <div>
                  <span className="text-xs font-black text-blue-900 uppercase tracking-wider block">Kategori A</span>
              ...
              {/* Preview image */}
              <div className="mb-3.5 rounded-xl overflow-hidden border border-gray-200 bg-slate-900 aspect-16/10">
                <picture>
              ...
              <ul className="space-y-2 text-sm text-gray-800 leading-normal">
            ...
            <div className="mt-4 pt-3 border-t border-slate-200 text-xs sm:text-sm text-blue-950 font-bold text-center">
          ...
          <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-5 flex flex-col justify-between shadow-xs">
            <div>
              <div className="flex items-center gap-2.5 mb-3">
                ...
                <div>
                  <span className="text-xs font-black text-emerald-700 uppercase tracking-wider block">Kategori B</span>
                  <h3 className="text-base font-black text-gray-900 leading-snug">
                    Dokumen Kerja
                  </h3>
                </div>
            ...
            <div className="mt-4 pt-3 border-t border-slate-200 text-xs sm:text-sm text-emerald-950 font-bold text-center">
          ...
          <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-5 flex flex-col justify-between shadow-xs">
            <div>
              <div className="flex items-center gap-2.5 mb-3">
                ...
                <div>
                  <span className="text-xs font-black text-indigo-700 uppercase tracking-wider block">Kategori C</span>
                  <h3 className="text-base font-black text-gray-900 leading-snug">
                    Materi Pembelajaran
                  </h3>
                </div>
            ...
            <div className="mt-4 pt-3 border-t border-slate-200 text-xs sm:text-sm text-indigo-950 font-bold text-center">
