...
export const FAQS: FaqItem[] = [
  {
    question: 'Apakah auditor pemula bisa menggunakannya?',
    answer: 'Sangat bisa! SMART Audit SYSTEM dirancang khusus agar auditor pemula pun bisa langsung menyusun pertanyaan audit 5W+1H, memverifikasi bukti objektif, merumuskan temuan PLOR, dan menganalisis CAPA tanpa rasa bingung memulai dari lembar kosong. Bagi lead auditor berpengalaman, sistem ini menghemat waktu persiapan administratif hingga 70%.'
  },
  {
    question: 'Apakah harus mahir menggunakan AI?',
    answer: 'Tidak perlu keahlian khusus AI. Antarmuka SMART Audit SYSTEM sangat mudah digunakan. Anda cukup memilih menu yang dibutuhkan (persiapan pertanyaan, temuan PLOR, atau analisis CAPA), lalu masukkan informasi proses atau klausul yang ingin diaudit. Sistem akan langsung menyajikan draf terstruktur siap pakai.'
  },
  {
    question: 'Apakah dokumennya dapat diedit?',
    answer: 'Ya, 100% dapat diedit. Seluruh 7 worksheet berformat standar Microsoft Word (.docx) dan Microsoft Excel (.xlsx) tanpa proteksi atau password, sehingga Anda bebas menyesuaikan logo, nama instansi, serta format kerja sesuai kebutuhan perusahaan.'
  },
  {
    question: 'Apakah ada biaya bulanan?',
    answer: 'Tidak ada biaya bulanan sama sekali. Pembayaran Rp197.000 adalah sekali bayar untuk akses seumur hidup (Lifetime Access), termasuk pembaruan materi dan dokumen kerja di masa mendatang.'
  },
  {
    question: 'Bagaimana cara mendapatkan akses?',
    answer: 'Setelah pembayaran terverifikasi, Anda akan langsung diarahkan ke Dashboard Web SMART Audit SYSTEM dan menerima link akses instan melalui email / WhatsApp. Anda bisa langsung menggunakan aplikasi AI dan mengunduh seluruh dokumen serta modul pembelajaran.'
  },
  {
    question: 'Apakah dapat digunakan melalui HP dan laptop?',
    answer: 'Ya, sistem berbasis web responsif modern yang dapat diakses dengan lancar melalui HP (smartphone), tablet, laptop, maupun PC tanpa perlu menginstal aplikasi tambahan.'
  },
  {
    question: 'Apakah tersedia lisensi untuk perusahaan?',
    answer: 'Akses standar seharga Rp197.000 berlaku untuk 1 pengguna (Personal License) untuk mendukung tugas audit Anda di tempat kerja. Jika Anda membutuhkan Lisensi Korporasi (multi-user untuk seluruh tim internal audit perusahaan) atau pelatihan internal, silakan hubungi tim kami via WhatsApp.'
  }
];
